<template>
  <div class="cloud-file-list-public">
    ...
    <el-pagination
      ...
      @current-change="listPublicCloudFile"
    />
  </div>
</template>
...
import { CloudFile, generateCloudFileURL, displayCloudFileTime, displayCloudFileIsPublic } from "@/ts/data";
...
export default class ListPublicCloudFile extends Vue {
  ...
  private mounted() {
    this.listPublicCloudFile();
  }

  private listPublicCloudFile(currPage?: number): void {
    this.total = 0;
    this.cloudFiles = [];
