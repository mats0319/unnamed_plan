...
func (s *cloudFileServiceTest) testListByUploader() {
	...
	// check res
	if err != nil || res == nil || res.Total != 1 || res.Files[0].FileId != s.testData.testFileID {
		s.passed = false
...
func (s *cloudFileServiceTest) testUpload() {
	...
	// invoke method
	_, err := s.service.Upload(context.Background(), req)

	// check res
	file, err2 := getFileByFileName(s.testData.testUploadFileName)

	if err != nil || err2 != nil || file.UploadedBy != s.testData.testUserID {
		s.passed = false
...
func (s *cloudFileServiceTest) testModify() {
	...
	if err != nil || err2 != nil || !file.IsPublic {
		s.passed = false
...
func (s *cloudFileServiceTest) testDelete() {
	...
	if err != nil || err2 != nil || !file.IsDeleted {
		s.passed = false
