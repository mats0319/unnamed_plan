...
func (s *noteServiceTest) testCreate() {
	...
	if err != nil || err2 != nil || res.Err != nil || note.Content != s.testData.testCreatedNoteContent {
		s.passed = false
...
func (s *noteServiceTest) testModify() {
	...
	if err != nil || err2 != nil || res.Err != nil || !note.IsPublic {
		s.passed = false
...
func (s *noteServiceTest) testDelete() {
	...
	if err != nil || err2 != nil || res.Err != nil || !note.IsDeleted {
		s.passed = false
