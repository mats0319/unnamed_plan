...
func (s *taskServiceTest) testList() {
	...
	// check res
	if err != nil || res == nil || res.Err != nil || res.Total != 1 || res.Tasks[0].TaskName != s.testData.testTaskName {
		s.passed = false
...
func (s *taskServiceTest) testCreate() {
	...
	if err != nil || err2 != nil || res.Err != nil || task.Description != s.testData.testCreatedTaskDesp {
		s.passed = false
...
func (s *taskServiceTest) testModify() {
	...
	if err != nil || err2 != nil || res.Err != nil || note.Status != s.testData.testModifyTaskStatus {
		s.passed = false
